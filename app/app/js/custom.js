...
.then(function(data){
  ...
  ZOHO.CRM.CONNECTOR.invokeAPI("crmandassist.zohoassist3.createsession",x)
  .then(function(dataa){
      console.log(dataa);
      ...
      console.log(representation);
       ...
       var recordData = {
        ...
        "crmandassist__Session_ID": sessionid,
        "crmandassist__Case_Name":EntityId,
        "crmandassist__Case_status_during_session_initiation":casestatus,

  }
ZOHO.CRM.API.insertRecord({Entity:"crmandassist__Session_Info",APIData:recordData,Trigger:[]}).then(function(data){
  console.log(data);
  });
